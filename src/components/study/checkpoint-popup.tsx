...
export function CheckpointPopup({ question }: CheckpointPopupProps) {
  return (
    <div className="absolute z-[60] bottom-full left-1/2 -translate-x-1/2 mb-4 w-80 animate-in fade-in-0 slide-in-from-bottom-2 zoom-in-95 duration-300 pointer-events-auto">
      <div className="relative bg-[#0a1f2e]/95 backdrop-blur-md rounded-2xl border border-[#ffa02f]/30 shadow-2xl shadow-[#ffa02f]/10 p-5">
