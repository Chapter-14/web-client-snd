...
export function CheckpointPopup({ question }: CheckpointPopupProps) {
  return (
    <div className="absolute z-[60] bottom-full left-1/2 -translate-x-1/2 mb-4 w-64 sm:w-80 max-w-[calc(100vw-2rem)] animate-in fade-in-0 slide-in-from-bottom-2 zoom-in-95 duration-300 pointer-events-auto">
